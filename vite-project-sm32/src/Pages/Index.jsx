  ...
  <div className="card-body">
    ...
    <a href="/Menu_producto" className="btn btn-primary">Detalles</a>
        ...
        <div className="ini-choco" id="caram">
					...
					<img src={cat6} className="img-cat" />
				</div>
        </div>
        <br />
        <br />
